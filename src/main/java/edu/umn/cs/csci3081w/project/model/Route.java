...
/**
 * This is the class for the route to load necessary data.
 */
public class Route {
  ...
  /**
   * Get the index of destination stop.
   *
   * @return index of destination stop
   */
  ...
  /**
   * Get the data of route.
   *
   * @return information of route
   */
  ...
  /**
   * Set the data of route.
   *
   * @param routeData information of route
   */
  ...
  /**
   * Check if it is at the end of stops.
   *
   * @return if it is the end of stops
   */
