...
/**
 * This is the class for the stop to load neccessary information.
 */
public class Stop implements StopObserver {
  ...
  /**
   * Get list of passengers at stop.
   *
  ...
  /**
   * Get the size of passengers at the stop.
   *
