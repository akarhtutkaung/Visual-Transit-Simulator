...
public class TimeOfDayConcreteBusCreatorTest {
  ...
  /**
   * Test set strategy morning.
   */
  @Test
  public void testSetStrategyMorning() {
  ...
  /**
   * Test set strategy day.
   */
  @Test
  public void testSetStrategyDay() {
    TimeOfDayConcreteBusCreator timeOfDayConcreteBusCreator =
        new TimeOfDayConcreteBusCreator();
  ...
  /**
   * Test set strategy evening.
   */
  @Test
  public void testSetStrategyEvening() {
    TimeOfDayConcreteBusCreator timeOfDayConcreteBusCreator =
        new TimeOfDayConcreteBusCreator();
  ...
  /**
   * Test set strategy night.
   */
  @Test
  public void testSetStrategyNight() {
    TimeOfDayConcreteBusCreator timeOfDayConcreteBusCreator =
        new TimeOfDayConcreteBusCreator();
    timeOfDayConcreteBusCreator.setStrategy(22);
    BusDeploymentStrategy busDeploymentStrategy =
        timeOfDayConcreteBusCreator.getStrategy();
